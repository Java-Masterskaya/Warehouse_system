...
/**
 * Интеграционные тесты для кэширования списка категорий.
 * Проверяют: получение уникальных активных категорий, кэширование, возврат данных из кэша при удалении из БД.
 */
@ActiveProfiles("test")
class ItemCategoriesCacheTest extends AbstractIntegrationTest {
    ...
    /**
     * Получение уникальных активных категорий.
     */
    @Test
