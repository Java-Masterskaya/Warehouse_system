...
.PHONY: up down app-up app-down infra-up infra-down health liveness readiness test build checkstyle clean help backup-now backup-list backup-restore backup-test
